...
define(['dojo/_base/declare',
  ...
  './MapUrlParamsHandler',
  './AppStateManager'
], function(declare, lang, array, html, topic,query, on, aspect, keys, Deferred, InfoWindow,
  PopupMobile, InfoTemplate, esriRequest, Extent, Point, require,
  jimuUtils, LoadingShelter, LayerInfos, GoogleLayer,TianDiTuLayer,MapUrlParamsHandler,
  AppStateManager) {
  var instance = null,
    clazz = declare(null, {
      appConfig: null,
        ...
        else if(layerConfig.type == "tianditumap" || layerConfig.type == "tiandituimage" || layerConfig.type == "tianditutrain")
        {
          ...
          require([layMap[maptype + '_' + layerConfig.type]], lang.hitch(this, function(layerClass) {
            ...
            if (layerConfig.infoTemplate) {
              ...
              layer = new layerClass(layerConfig.url, options);
              //layer = new layerClass(layerConfig.url);
            }

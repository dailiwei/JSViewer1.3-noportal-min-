...
(function (argument) {
    ...
    if (!window.apiUrl) {
        ...
        resources = resources.concat([
            ...
            window.apiUrl + 'gridx/resources/claro/Gridx.css',
            window.apiUrl + "gridx/resources/claro/Gridx_rtl.css"
        ]);
        ...
        if (window.apiUrl.substr(window.apiUrl.length - 'arcgis-js-api/'.length,
            ...
            dojoConfig.packages = [{
                ...
                name: "gridx",
                location: window.path + "esrilib/gridx"
            }];
